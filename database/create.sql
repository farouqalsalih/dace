...
CREATE TABLE IF NOT EXISTS entries (
    ...
    dist_ri_csv_link VARCHAR(150) DEFAULT NULL,
    serialized_trace_link VARCHAR(150) NOT NULL,
    serialized_hist_rd_link VARCHAR(150) NOT NULL,
    serialized_hist_ri_link VARCHAR(150) DEFAULT NULL,
    serialized_dist_rd_link VARCHAR(150) NOT NULL,
    serialized_dist_ri_link VARCHAR(150) DEFAULT NULL,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    created_by VARCHAR(100) NOT NULL,
    PRIMARY KEY (program_name, lru_type, argdata, loop_code_hash),
